...
long long day14_1(std::string dataFile) {
    ...
    auto input = std::stoi(incom::aoc::parseInputUsingCTRE::processOneLineRPTinFile(dataFile, d_ctre).front().front());
...
long long day14_2(std::string dataFile) {
    auto d_ctre = ctre::search<R"(\d+)">;
    auto input  = incom::aoc::parseInputUsingCTRE::processOneLineRPTinFile(dataFile, d_ctre).front().front();
